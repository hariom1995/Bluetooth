...
class Bluetooth extends Component {
   ...
   */
    requestEnable() {
        BluetoothSerial.requestEnable()
            ...
            .catch((err) => console.log('requestEnable time error', err))
    }
   ...
   */
    enable() {
        BluetoothSerial.enable()
            .then((res) => this.setState({ isEnabled: true }))
            .catch((err) => console.log('enable time error'))
    }
    ...
    disable() {
        BluetoothSerial.disable()
            ...
            .catch((err) => console.log('disable time error'))
    }
  ...
  */
    discoverUnpaired() {
        console.log('calling discover function')
